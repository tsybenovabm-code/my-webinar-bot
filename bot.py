...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if is_new:
        text = (
            ...
            "А ещё у нас стартует Неделя алгоритмов — открытый бесплатный курс для тех, "
            "кто хочет прокачать алгоритмическое мышление и подготовиться к собесам.\n\n"
            "Нажми на кнопки ниже, чтобы вступить 👇"
        )
    else:
        text = (
