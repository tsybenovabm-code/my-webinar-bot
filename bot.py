...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if is_new:
        text = (
            ...
            "Мы очень сожалеем, что не смогли вместить всех желающих на вебинар — "
            "мы столкнулись с техническими проблемами на платформе.\n\n"
            "🎁 *В качестве извинения дарим тебе бесплатный доступ к курсу по SQL.*"
            " Для аналитика SQL — один из главных инструментов работы с данными.\n\n"
            "Нажми кнопку ниже, чтобы вступить в закрытый канал с курсом 👇\n\n"
            "А ещё совсем скоро мы проведём *дополнительный вебинар* про A/B-тесты — "
            "уведомление придёт прямо сюда и на наш канал Поступашки, не забудь включить уведомления 😊"
        )
    else:
        text = (
